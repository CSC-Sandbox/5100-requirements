...
To test the encrypted message, copy it into `DecryptMessage.java`.
## Decrypt Message
...
Alternatively, the user may enter `/quit` to exit the program.<br>
To test, encrypt a message in `EncryptMessage.java` and paste its output into `DecryptMessage.java`.